...
import { faBook, faUser, faUserGraduate, faLocationDot, faClock } from '@fortawesome/free-solid-svg-icons'

    // Add icons to library
library.add(faBook, faUser, faUserGraduate, faLocationDot, faClock)
